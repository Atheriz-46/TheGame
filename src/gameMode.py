class GameMode:
    ...
    def __init__(
        self, velocityBullets=10, regenBullets=10, balloonSeed=800, balloonCount=20
    ):
        """
        Args:
    ...
    def getState(self):
        ...
        """
        return {
            "velocityBullets": self.velocityBullets,
            "regenBullets": self.regenBullets,
            "balloonSeed": self.balloonSeed,
            "balloonCount": self.balloonCount,
        }
